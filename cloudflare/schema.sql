...
INSERT OR IGNORE INTO routes (label, origin, destination, start_date, end_date, active, created_at) VALUES
  ...
  ('تهران-کیش',       'THR,IKA,PYK', 'KIH',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('کیش-تهران',       'KIH',         'THR,IKA,PYK', '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('تهران-تبریز',     'THR,IKA,PYK', 'TBZ',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('تبریز-تهران',     'TBZ',         'THR,IKA,PYK', '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('تبریز-مشهد',      'TBZ',         'MHD',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('مشهد-تبریز',      'MHD',         'TBZ',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('مشهد-اهواز',      'MHD',         'AWZ',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('اهواز-مشهد',      'AWZ',         'MHD',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('تهران-اهواز',     'THR,IKA,PYK', 'AWZ',         '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('اهواز-تهران',     'AWZ',         'THR,IKA,PYK', '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('تبریز-استانبول',  'TBZ',         'TEQ,SAW,IST', '2026-08-01', '2026-08-30', 1, datetime('now')),
  ('استانبول-تبریز',  'TEQ,SAW,IST', 'TBZ',         '2026-08-01', '2026-08-30', 1, datetime('now'));
